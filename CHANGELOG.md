...
- implementar lista de conexões na barra lateral e refatorar lógica de conexão (5aa078f)
...
- adicionando novas infos no site (8706fe2)
...
- corrigir seletor do Zustand para evitar laço de renderização (f8fe147)
...
- implementar validação de comandos de escrita na exportação e ajustes em testes (70c0cc8)
...
- adicionar testes de cobertura para documentação de hover por dialeto (156e91c)
- adicionar suporte a previewRows e ajustar lógica de limite nas consultas (b58a2f8)
